...
import HoverElementEconomy from "./HoverElementEconomy";

export default function EconomySeat({
  status = "available",
  is_crown = false,
  is_star = false,
  is_red = false,
    ...
    >
      ...
      >
        ...
        >
          <path
            strokeWidth="1.2"
            d="M11.1 4.673h10.995c.981 0 1.824.699 2.006 1.663l2.536 13.45a2.041 2.041 0 01-2.006 2.419H9.04a2.041 2.041 0 01-2.018-2.35l2.06-13.45A2.041 2.041 0 0111.1 4.673z"
          ></path>
          <rect
            width="2.744"
            height="11.734"
          ...
          <rect
            ...
            strokeWidth="1.2"
            rx="1.407"
            transform="rotate(90 22.257 25.635)"
          ></rect>
        </svg>
      ...
      {clickable && (
        <>
          <span className="text-[7px] sm:text-[11px] m-0 p-0 absolute top-1/2 left-1/2  text-white uppercase -translate-y-[6px] -translate-x-1/2">
            {user_short_name}
          </span>
          <span
      ...
      {status === "selected" && (
        <HoverElementEconomy hidePopUp={HideSeatNumber} />
      )}
    </div>
  );
}
